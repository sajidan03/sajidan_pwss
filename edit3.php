...
<body>
    ...
    if (isset($_POST['edit'])) {
        ...
        // Update query
        $query_update = mysqli_query($koneksi, "UPDATE penjualan SET nama='$nama', username='$username', level='$level' WHERE id='$id'");
    ...
    <h1>Edit Data</h1>
    <form action="edit3.php?id=<?= $data['id'] ?>" method="post">
        <table>
            <tr>
                <td>Nama</td>
